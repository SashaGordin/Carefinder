...
export default function CPRoomEdit() {
  ...
  const roomTypes = [
    '',
    'Private room',
    'Private room, private half bathroom',
    'Private room, private full bathroom',
    'Private room, shared community bathroom',
    'Private room, shared full bathroom',
    'Shared room, community bathroom',
    'Shared room, shared half bathroom',
    'Shared room, shared full bathroom',
  ];
  const roomFeatures = [
    'Room on secondary floor',
    'Room near night staff',
    'Room has pleasant view',
    'Room has door to outside',
    'Room has regular doors',
    'Room has larger doors',
  ];
  const roomSizes = [
    {
      name: 'Standard',
      attr: [
        '10x10 ft',
        '110 sq ft',
        'Fits standard bed and essential personal items',
      ],
    },
    {
      name: 'Medium',
      attr: [
        '10x12 ft',
        '120-140 sq ft',
        'Allows comfortable movement and additional furniture',
      ],
    },
    {
      name: 'Large',
      attr: [
        '11x13 ft',
        '140-160 sq ft',
        'Provides ample space for personalization',
      ],
    },
    {
      name: 'Premium/Master',
      attr: ['12x14 ft', '160-200 sq ft', 'Luxury living '],
    },
  ];
        ...
        <Card>
          <Card.Body>
            ...
            <Row>
              <Col>
                <FileUpload
                  controlId="roomPhotoUpload"
                  handleNewFiles={handleNewPics}
                  folderPath={folderPath}
                  allowMultipleFiles={true}
                  uploadLabel="Upload photos of room"
                  uploadType="Photo"
                />
                <div>
                ...
                <div>
                  ...
                  <Form.Select
                    name="sizeId"
                    value={roomInfo.sizeId ?? 0}
                    onChange={handleChange}
                  >
                    {roomSizes.map((size, i) => {
                      return (
                        <option key={i} className="small" value={i}>
                          {size.name}
                        </option>
                      );
                    })}
                ...
                <ul>
                  {roomSizes[roomInfo.sizeId ?? 0].attr.map((attr, i) => {
                ...
                <div>
                  ...
                  <Form.Select
                    ...
                    value={roomInfo.medicaidAccepted ?? 'N'}
                    onChange={handleChange}
                  >
