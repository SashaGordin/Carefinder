      ...
      <div className="contentContainer utilityPage">
        <Card>
          <Card.Body>
            ...
            <p>
              Got something on your mind? Let us know anytime, and please
              include as much detail as you can, as well as your contact info if
              you would like a response. Thanks! 🙏
            </p>
            <textarea
              id="theMessage"
              style={{
        ...
        {messageSent && (
          <div
            ...
            role="alert"
          >
            👍Message sent! A CareFinder admin will get back with you soon, if
            needed.
          </div>
        )}
      </div>
