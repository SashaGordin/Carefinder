...
export default function SupportSuggestion() {
    ...
    const handleSubmit = async () => {
        ...
        const messagePrepend = 'MESSAGE FROM SUGGESTION PAGE: ';
    ...
    return (
        ...
        <div className="contentContainer utilityPage">
            ...
            <Card.Body>
                ...
                <p>Please include as much detail as you can, as well as your contact info if you would like a response. Thanks! 🙏</p>
