    ...
    <>
      <Card className="claimProfileCard">
        <Card.Body>
          ...
          <Card.Text>
            You will need at least five photos to get started, you will be able
            to add more and edit later. (exterior, interior, common areas) No
            room photos
          </Card.Text>
          <Form.Group
            controlId="formFileMultiple"
            className="mb-3 CFgrayBackground"
          >
