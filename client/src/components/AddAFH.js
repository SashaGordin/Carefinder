...
export default function AddAFH({ uid }) {
  ...
  return (
    <>
      <Card>
        <CardBody>
          <CardTitle>Add AFH</CardTitle>
          <CardText>
            Please note: Adding another AFH will automatically place you into
            our "multiple home membership" tier. As always, you won't be charged
            until you land your first resident in this specific home.
          </CardText>
