  ...
  return (
    <>
        ...
        <div className="contentContainer">
          ...
          <div className="right60">
            ...
            <p>
              ...
              advisor -- all for a low flar annual membership fee.
            </p>
            <button
              type="button"
      ...
      <div className="CProw3 CFpinkBackground">
        <div className="contentContainer">
          <p>
            Your subscription fee is not due until you land your first resident
            who stays more than 30 days!
          </p>
        </div>
      </div>
      ...
      <div className="CProw4 CFblackBackground">
        <div className="contentContainer">
          <div className="CPchoiceBox CFgrayBackground">
            ...
            <p className="CPboxText">
              By listing your AFH, make it visible to all seniors seeking care
              at no cost. Once you've welcomed your first private pay resident,
              your subscription will be activated.
            </p>
            <button
              type="button"
              className="btn btn btn-dark button2"
              onClick={handleButtonClick}
            >
              Review agreement
            </button>
          ...
          <div className="CPchoiceBox CPchoiceBox2 CFgrayBackground">
            ...
            <p className="CPboxText">
              Secure a private pay resident, after 30 days your subscription
              activates. We charge $100/month for 24 months per successful
              booking. ($2,400 max)
            </p>
            ...
            <ul style={listStyle} className="custom-checkmark-list">
              <li style={listItemStyle}>
                No large upfront fees or commission.
              </li>
              <li style={listItemStyle}>
                Spread your payments over 24 months, reducing financial strain.
              </li>
              <li style={listItemStyle}>
                Start paying only after the resident has stayed for at least 30
                days.
              </li>
              <li style={listItemStyle}>
        ...
        <div className="contentContainer">
          ...
          <Accordion>
            <Accordion.Item eventKey="0">
              ...
              <Accordion.Body>
                Carefinder addresses the shortcomings of traditional senior
                referral and placement agencies, offering transparency and
                unbiased guidance. We empower families to make informed
                decisions while providing a cost-effective solution for care
                providers.
              </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey="3">
              ...
              <Accordion.Body>
                Non-members secure a new resident at no upfront cost. After 30
                days, if the resident stays, we charge an annual membership fee
                of $1,800, offering unlimited access for 12 months.
              </Accordion.Body>
            </Accordion.Item>
            ...
            <Accordion.Item eventKey="6">
              <Accordion.Header>
                What if I change my mind about a resident?
              </Accordion.Header>
              <Accordion.Body>
                While we encourage communication, ultimately, your home operates
                by your rules. Families can find a new home, and our support
                team can assist.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="7">
              <Accordion.Header>
                What if the family wants to move their senior?
              </Accordion.Header>
              <Accordion.Body>
                No charge within 30 days, after which there's a fee. However,
                with our model, you can always land your next resident at no
                extra cost.
              </Accordion.Body>
            </Accordion.Item>
          </Accordion>
