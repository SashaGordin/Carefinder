...
export default function ReserveRoom() {
  ...
  return(
    ...
    <div className="contentContainer utilityPage">
      ...
      {currentStep === 3 && <Step3 onNext={handleNext} onBack={handleBack} houseName={provider.FacilityName}/>}
      {currentStep === 4 && <Step4 onNext={handleNext} onBack={handleBack} providerInfo={provider}/>}
      {currentStep === 5 && <Step5 onNext={handleNext} onBack={handleBack} providerInfo={provider}/>}
      {currentStep === 6 && <Step6 onNext={handleNext} onBack={handleBack} providerInfo={provider}/>}
