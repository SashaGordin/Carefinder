...
export default function Listings({ userData }) {
  ...
  let toggleImg =
    listingStatus === 'Listing is on' ? 'toggleon.png' : 'toggleoff.png';
  let btnText =
    listingStatus === 'Incomplete' ? 'Create listing' : 'Edit listing';
      ...
      <Card className="CFListingCard">
        <Card.Body>
          <div className="CFListingCardHeader">
            ...
            <div className="ml-auto" onClick={toggleListing}>
              <img alt="" src={toggleImg} />
            </div>
          </div>
          <Card.Title>
            <h5>{userData.FacilityName}</h5>
          </Card.Title>
          <div className="CFListingImgContainer">
            <div className="CFPlaceholderImg">
              <img alt="" src={userData.listingImg ?? defaultListingImg} />
            </div>
          </div>
