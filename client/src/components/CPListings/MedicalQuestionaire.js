...
export default function MedicalQuestionaire({
  listingInfo,
  setListingInfo,
  handleUpdate,
}) {
  ...
  const covidInfectionOptions = [
    'Covid 19 positive & requires isolation',
    'Covid 19 tested presumed positive',
    'Covid 19 not tested',
    ...
    <>
      <div id={sectionId}>
          ...
          <div>
            {covidImmunityOptions.map((option, i) => (
              <Form.Check
                ...
                label={option}
                checked={
                  listingInfo.covidImmunitiesAccepted?.includes(i) ?? false
                }
                onChange={handleChange}
              />
            ))}
        ...
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="acceptsMedicaidOnArrival"
            value="1"
            checked={
              listingInfo.acceptsMedicaidOnArrival?.length > 0 ? true : false
            }
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="acceptsPrivatePay"
            value="1"
            checked={listingInfo.acceptsPrivatePay?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="acceptsVABenefits"
            value="1"
            checked={listingInfo.acceptsVABenefits?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            value="1"
            checked={listingInfo.acceptsLTCInsurance?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div>
        ...
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            value="1"
            checked={listingInfo.diabetesManagement?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            name="oxygenAdmin"
            value="1"
            checked={listingInfo.oxygenAdmin?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            name="colostomyCare"
            value="1"
            checked={listingInfo.colostomyCare?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            value="1"
            checked={
              listingInfo.privatePayToMedicaid?.length > 0 ? true : false
            }
            onChange={handleChange}
          />
        </div>
        ...
        <div className={'switchBtnGrp'}>
          <label>
            Care provider accepts patients with mental decline not due to
            dementia/alzheimers
          </label>
          <Form.Switch
            inline
            name="mentalDeclineAccepted"
            value="1"
            checked={
              listingInfo.mentalDeclineAccepted?.length > 0 ? true : false
            }
            onChange={handleChange}
          />
        </div>
        ...
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            name="insulinCare"
            value="1"
            checked={listingInfo.insulinCare?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            value="1"
            checked={
              listingInfo.nonInsulinDiabetesCare?.length > 0 ? true : false
            }
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="feedingTubeCare"
            value="1"
            checked={listingInfo.feedingTubeCare?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            name="catheterCare"
            value="1"
            checked={listingInfo.catheterCare?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
        ...
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            name="hospiceCare"
            value="1"
            checked={listingInfo.hospiceCare?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="smokersAccepted"
            value="1"
            checked={listingInfo.smokersAccepted?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="awakeStaffAtNight"
            value="1"
            checked={listingInfo.awakeStaffAtNight?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="bariatricAccepted"
            value="1"
            checked={listingInfo.bariatricAccepted?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            ...
            name="palliativeCare"
            value="1"
            checked={listingInfo.palliativeCare?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="mechanicalHoyerLift"
            value="1"
            checked={listingInfo.mechanicalHoyerLift?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="acceptsHomeless"
            value="1"
            checked={listingInfo.acceptsHomeless?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="acceptsPatientsWithBehaviors"
            value="1"
            checked={
              listingInfo.acceptsPatientsWithBehaviors?.length > 0
                ? true
                : false
            }
            onChange={handleChange}
        ...
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="acceptsPatientsOnPAMeds"
            value="1"
            checked={
              listingInfo.acceptsPatientsOnPAMeds?.length > 0 ? true : false
            }
            onChange={handleChange}
          />
        </div>
        <div className={'switchBtnGrp'}>
          ...
          <Form.Switch
            inline
            name="acceptsExitSeekers"
            value="1"
            checked={listingInfo.acceptsExitSeekers?.length > 0 ? true : false}
            onChange={handleChange}
          />
        </div>
        <div>
          ...
          <Row>
            {targetResidentOptions.map((option, i) => (
              <Col xs={4} key={i}>
                <Form.Check
