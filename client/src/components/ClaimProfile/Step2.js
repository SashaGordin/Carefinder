...
export default function Step2({ onNext, onBack, providerInfo }) {
  ...
  const verifyConfirmationCode = () => {
    ...
    axios
      .post(`${process.env.REACT_APP_ENDPOINT}/verifyConfirmationCode`, {
        phoneNumber: providerInfo.TelephoneNmbr,
    ...
    <>
      <Card className="claimProfileCard">
        <Card.Body>
          ...
          <Card.Text>
            Please confirm your phone number by entering the confirmation code
            received via SMS.
          </Card.Text>
          <Form>
