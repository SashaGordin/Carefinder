...
const MessageAdminSpoof = () => {
  ...
  const sendMessage = async () => {
    ...
    if (messageSenderID === messageReceiverID) {
      alert('Sender and recipient must differ. Kthx. :-)');
      return;
    }
  ...
  return (
    <>
      ...
      <div className="contentContainer utilityPage">
        ...
        <p>
          This utility allows you to send a message from any ID to any other ID.
          Good for testing, as you can change up the sender and receiver at
          will. The FLIP button allows you to quickly flipflop the
          sender/receiver, which allows you to quickly simulate actual
          "conversations" in the messaging system. If you know the threadID, pop
          it in and you can work within a single conversation. If not, a new
          thread will be started. For now, the "type" is there to simply mark it
          as such in the DB... it does not do any formatting like real
          quote/meeting requests do.
        </p>
        ...
        <textarea
          id="theMessage"
          style={{ display: 'block', width: 500, height: 200 }}
        ></textarea>

        <button
          onClick={sendMessage}
          style={{ padding: 20, marginTop: 20, marginRight: 20 }}
        >
          SEND
        </button>
        <button
          onClick={flipflopSenderReceiver}
