    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        if (user && !user.emailVerified) {
          ...
          setError(
            'User is either not logged in or has already verified their email.'
          );
        }
      } else {
      ...
      <div className="contentContainer utilityPage loginPage">
        <Card>
          <Card.Body>
            ...
            <p>
              If you did not receive a verification email, you can click the
        ...
        <div class="text-center">
          <p>
            <br></br>Once verified, you may <a href="/login">login</a>.
          </p>
        </div>
      </div>
