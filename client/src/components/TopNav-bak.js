  ...
  return (
    <>
      <div
        ...
        style={{ backgroundColor: '#1E1E1E', padding: '10px 0' }}
      >
        <div
        ...
        >
          <div className="topNavLeft">
            ...
            >
              <img
                src={process.env.PUBLIC_URL + '/cflogo.png'}
                alt="Welcome to CareFinder"
          ...
          <div className="topNavRight" style={{ display: 'flex', gap: '20px' }}>
            ...
            {role === 'client' && (
              <Nav
                className="nav-pills"
                style={{ gap: '20px', fontWeight: 500, color: 'white' }}
              >
                <Nav.Item>
                  <Nav.Link
            ...
            {role === 'admin' && (
              ...
              >
                ...
                <NavDropdown
                  ...
                  id="admin-utils"
                  style={{
                    color: activePage.startsWith('/msg') ? 'white' : '#777777',
                  }}
                >
                  <NavDropdown.Item
                    href="/msg-inbox"
                    ...
                    onClick={() => handleNavClick('/msg-inbox')}
                    style={{
                      color: activePage === '/msg-inbox' ? 'white' : '#777777',
                    }}
                  >
                    Inbox
                  </NavDropdown.Item>
                  <NavDropdown.Item
                    ...
                    style={{
                      color: activePage === '/msg-outbox' ? 'white' : '#777777',
                    }}
                  >
                    Outbox
                  </NavDropdown.Item>
                ...
                <NavDropdown
                  ...
                  id="admin-utils"
                  style={{
                    color: activePage.startsWith('/admin')
                      ? 'white'
                      : '#777777',
                  }}
                >
                  <NavDropdown.Item
                    ...
                    style={{
                      color: activePage === '/msg-admin' ? 'white' : '#777777',
                    }}
                  >
                    Admin Messager
                  </NavDropdown.Item>
                  <NavDropdown.Item
                    ...
                    style={{
                      color:
                        activePage === '/msg-admin-spoof' ? 'white' : '#777777',
                    }}
                  >
                  ...
                  <NavDropdown.Item
                    ...
                    style={{
                      color:
                        activePage === '/admin-client-viewer'
                          ? 'white'
                          : '#777777',
                    }}
                  >
                ...
                <NavDropdown
                  ...
                  id="client-dropdown"
                  style={{
                    color: activePage.startsWith('/client')
                      ? 'white'
                      : '#777777',
                  }}
                >
                  ...
                  <NavDropdown.Item
                    ...
                    style={{
                      color:
                        activePage === '/client-menu' ? 'white' : '#777777',
                    }}
                  >
                    Client Menu
                  </NavDropdown.Item>
                ...
                <NavDropdown
                  ...
                  style={{
                    color: activePage.startsWith('/provider')
                      ? 'white'
                      : '#777777',
                  }}
                >
                  <NavDropdown.Item
                    ...
                    style={{
                      color:
                        activePage === '/provider-menu' ? 'white' : '#777777',
                    }}
                  >
                    Provider Menu
                  </NavDropdown.Item>
                  <NavDropdown.Item
                    ...
                    style={{
                      color:
                        activePage === '/care-provider-dashboard'
                          ? 'white'
                          : '#777777',
                    }}
                  >
                  ...
                  <NavDropdown.Item
                    ...
                    onClick={() => handleNavClick('/my-afh')}
                    style={{
                      color: activePage === '/my-afh' ? 'white' : '#777777',
                    }}
                  >
                    Provider Listings
                  </NavDropdown.Item>
